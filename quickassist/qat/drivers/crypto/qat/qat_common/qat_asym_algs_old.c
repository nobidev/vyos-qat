...
/* Copyright(c) 2016, 2018 - 2019, 2021 Intel Corporation */
...
static int qat_alg_send_asym_message(struct qat_rsa_request *qat_req,
				     struct qat_crypto_instance *inst,
...
void qat_alg_asym_callback(void *_resp)
{
	...
	struct qat_rsa_request *areq = (void *)(__force long)resp->opaque;
...
int qat_rsa_get_n(void *p1, size_t p2, unsigned char p3, const void *p4, size_t p5)
{
        return 0;
}

int qat_rsa_get_e(void *p1, size_t p2, unsigned char p3, const void *p4, size_t p5)
{
        return 0;
}

int qat_rsa_get_d(void *p1, size_t p2, unsigned char p3, const void *p4, size_t p5)
{
        return 0;
}
#endif
