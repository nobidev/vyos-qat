...
enum icp_qat_capabilities_mask {
	...
	ICP_ACCEL_CAPABILITIES_RESERVED_2 = BIT(10),
	...
	ICP_ACCEL_CAPABILITIES_CIPHER_CRC = BIT(28),
...
struct icp_qat_hw_auth_ghash {
	struct icp_qat_hw_auth_setup inner_setup;
	u8 inner_state1[ICP_QAT_HW_GALOIS_128_STATE1_SZ];
	u8 inner_state2[ICP_QAT_HW_GALOIS_H_SZ +
...
struct icp_qat_hw_auth_algo_blk {
	union{
		...
		struct icp_qat_hw_auth_ghash ghash;
	} auth;
};
#else
struct icp_qat_hw_auth_algo_blk {
