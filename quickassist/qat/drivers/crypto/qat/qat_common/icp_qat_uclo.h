...
#define ICP_QAT_AC_D15XX_DEV_TYPE  ICP_QAT_AC_C62X_DEV_TYPE
...
/* SHA256-bit firmware authentication */
#define ICP_QAT_CSS_2K_FWSK_MODULUS_LEN		256
#define ICP_QAT_CSS_2K_FWSK_PAD_LEN		252
#define ICP_QAT_CSS_2K_SIGNATURE_LEN		256
#define ICP_QAT_CSS_2K_FWSK_EXPONENT_LEN	4

#define ICP_QAT_CSS_2K_FWSK_PUB_LEN (ICP_QAT_CSS_2K_FWSK_MODULUS_LEN + \
				     ICP_QAT_CSS_2K_FWSK_EXPONENT_LEN + \
				     ICP_QAT_CSS_2K_FWSK_PAD_LEN)
#define ICP_QAT_CSS_AE_IMG_LEN (sizeof(struct icp_qat_simg_ae_mode) + \
				ICP_QAT_SIMG_AE_INIT_SEQ_LEN +         \
				ICP_QAT_SIMG_AE_INSTS_LEN)
#define ICP_QAT_CSS_2K_AE_SIMG_LEN (sizeof(struct icp_qat_css_hdr) + \
				    ICP_QAT_CSS_2K_FWSK_PUB_LEN + \
				    ICP_QAT_CSS_2K_SIGNATURE_LEN + \
				    ICP_QAT_CSS_AE_IMG_LEN)
#define ICP_QAT_AE_2K_IMG_OFFSET (sizeof(struct icp_qat_css_hdr) + \
				  ICP_QAT_CSS_2K_FWSK_MODULUS_LEN + \
				  ICP_QAT_CSS_2K_FWSK_EXPONENT_LEN + \
				  ICP_QAT_CSS_2K_SIGNATURE_LEN)
...
struct icp_qat_mof_chunkhdr {
	char chunkId[ICP_QAT_MOF_OBJ_ID_LEN];
	u64  offset;
	u64  size;
};
...
struct icp_qat_mof_obj_chunkhdr {
	char         chunkId[ICP_QAT_MOF_OBJ_CHUNKID_LEN];
	u64          offset;
	u64          size;
	unsigned int name;
	unsigned int reserved;
