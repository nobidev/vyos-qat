...
/*
 * ADF_PFIEERRUNCSTSR: PF IE uncorrectable error status register
 * ADF_PFIEERRUNCFER: PF IE uncorrectable error first error register
 * ADF_PFIEERRUNCNER: PF IE uncorrectable error next error register
 */
#define ADF_PFIEERRUNCSTSR 0x280
#define ADF_PFIEERRUNCFER 0x288
#define ADF_PFIEERRUNCNER 0x28C
...
#endif
#ifdef QAT_DBG
#define IOCTL_DEBUG_STATUS_ACCEL_DEV _IOW(ADF_CTL_IOC_MAGIC, 100, uint32_t)
#endif
...
#define IOCTL_RESET_ACCEL_DEV _IOW(ADF_CTL_IOC_MAGIC, 10, \
				struct adf_user_cfg_ctl_data)
#define IOCTL_SLA_GET_CAPS _IOW(ADF_CTL_IOC_MAGIC, 11, \
				struct adf_user_sla_caps)
#define IOCTL_SLA_CREATE _IOW(ADF_CTL_IOC_MAGIC, 12, \
				struct adf_user_sla)
#define IOCTL_SLA_UPDATE _IOW(ADF_CTL_IOC_MAGIC, 13, \
				struct adf_user_sla)
#define IOCTL_SLA_DELETE _IOW(ADF_CTL_IOC_MAGIC, 14, \
				struct adf_user_sla)
#define IOCTL_SLA_GET_LIST _IOW(ADF_CTL_IOC_MAGIC, 15, \
				struct adf_user_slas)
#define IOCTL_DU_START _IOW(ADF_CTL_IOC_MAGIC, 16, \
				struct adf_pci_address)
#define IOCTL_DU_STOP _IOW(ADF_CTL_IOC_MAGIC, 17, \
				struct adf_pci_address)
#define IOCTL_DU_QUERY _IOW(ADF_CTL_IOC_MAGIC, 18, \
				struct adf_user_du)
#define IOCTL_DU_QUERY_VF _IOW(ADF_CTL_IOC_MAGIC, 19, \
				struct adf_user_du)
#define IOCTL_CLEAR_SYS_RESOURCE_PARAMETERS _IOW(ADF_CTL_IOC_MAGIC, 20, \
				struct adf_user_cfg_ctl_data)
#define IOCTL_CHECK_CFG_SECTION _IOW(ADF_CTL_IOC_MAGIC, 21, \
