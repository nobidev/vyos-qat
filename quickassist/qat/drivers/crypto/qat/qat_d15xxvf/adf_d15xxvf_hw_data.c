...
#include "adf_d15xxvf_hw_data.h"
#include "adf_gen2_hw_data.h"
#include "icp_qat_hw.h"
#include "adf_cfg.h"

static struct adf_hw_device_class d15xxiov_class = {
	.name = ADF_D15XXVF_DEVICE_NAME,
	.type = DEV_D15XXVF,
	.instances = 0
};
...
{
	return ADF_D15XXIOV_ACCELERATORS_MASK;
}

static u32 get_ae_mask(struct adf_accel_dev *accel_dev)
{
	return ADF_D15XXIOV_ACCELENGINES_MASK;
}

static u32 get_num_accels(struct adf_hw_device_data *self)
{
	return ADF_D15XXIOV_MAX_ACCELERATORS;
}

static u32 get_num_aes(struct adf_hw_device_data *self)
{
	return ADF_D15XXIOV_MAX_ACCELENGINES;
}

static u32 get_misc_bar_id(struct adf_hw_device_data *self)
{
	return ADF_D15XXIOV_PMISC_BAR;
}

static u32 get_etr_bar_id(struct adf_hw_device_data *self)
{
	return ADF_D15XXIOV_ETR_BAR;
}
...
{
	return ADF_D15XXIOV_PF2VF_OFFSET;
}

static u32 get_vintmsk_offset(u32 i)
{
	return ADF_D15XXIOV_VINTMSK_OFFSET;
}
...
static u32 d15xxiov_get_hw_cap(struct adf_accel_dev *accel_dev)
{
	...
	pci_read_config_dword(pdev, ADF_D15XX_VFLEGFUSE_OFFSET,
			      &legfuses);
	capabilities =
...
{
	hw_data->dev_class = &d15xxiov_class;
	hw_data->num_banks = ADF_D15XXIOV_ETR_MAX_BANKS;
	hw_data->num_rings_per_bank = ADF_ETR_MAX_RINGS_PER_BANK;
	hw_data->num_accel = ADF_D15XXIOV_MAX_ACCELERATORS;
	hw_data->num_logical_accel = 1;
	hw_data->num_engines = ADF_D15XXIOV_MAX_ACCELENGINES;
	hw_data->tx_rx_gap = ADF_D15XXIOV_RX_RINGS_OFFSET;
	hw_data->tx_rings_mask = ADF_D15XXIOV_TX_RINGS_MASK;
	...
	hw_data->get_accel_cap = d15xxiov_get_hw_cap;
