...
#define ADF_MAX_SKUS 3
#define ADF_C62X_FREQ_SKUS 2
#define ADF_C62X_ROOT_DEV0 0x37c0
#define ADF_C62X_ROOT_DEV1 0x37c1
#define ADF_PCIE_SLOT_OFFSET 19
#define ADF_PCIE_LNKCAP_MLW_SHIFT 4
#define ADF_PCIE_LNK_X4 4
#define ADF_PCIE_LNK_X8 8
#define ADF_PCIE_LNK_X16 16

enum adf_c62x_sku_variant {
	ADF_C62X_SKU_3X8 = 0,
	ADF_C62X_SKU_3X16,
	ADF_C62X_SKU_3X24
};

enum adf_c62x_freq_variant {
	ADF_C62X_DEFAULT = 0,
	ADF_C62X_800MHZ
};
#endif
