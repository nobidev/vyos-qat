...
#define ADF_200XX_ERRMSK3_NON_VF2PF (0xFFFFFFFF & ~ADF_200XX_VF2PF1_16)
#define ADF_200XX_ERR_REG_VF2PF(vf_src) (((vf_src) & 0x01FFFE00) >> 9)
...
#define ADF_200XX_ERRMSK3_UERR		(BIT(6) | BIT(5) | BIT(4) | BIT(3) | \
					 BIT(2) | BIT(0))
...
/* Firmware Binary */
#define ADF_200XX_FW "qat_200xx.bin"
#define ADF_200XX_MMP "qat_200xx_mmp.bin"
