...
#define qat_alg_skcipher_ctx qat_alg_ablkcipher_ctx
#define skcipher_request ablkcipher_request
#define skcipher_ctx ablkcipher_ctx
#define skcipher_req ablkcipher_req
#if KERNEL_VERSION(4, 3, 0) > LINUX_VERSION_CODE
#define QAT_AEAD_OLD_SUPPORTED
#else
#define QAT_ABLKCIPHER_SUPPORTED
#endif
#else
#define QAT_SKCIPHER_SUPPORTED
#endif
...
static inline void pci_ignore_hotplug(struct pci_dev *dev)
{
	...
	(!SLE_VERSION_CODE && !RHEL_RELEASE_CODE && \
...
#define timespec64 timespec
	...
	(KERNEL_VERSION(4, 18, 3) >= LINUX_VERSION_CODE))
#define UIO_IRQ_ONESHOT IRQF_ONESHOT
#else
#define UIO_IRQ_ONESHOT 0
#endif
